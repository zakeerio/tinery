<!-- Navbar -->
  <nav id="nav_variant" class="main-header navbar navbar-expand {{config('settings.ctrl_navbar_variant')}} {{config('settings.ctrl_nav_noborder')}} {{config('settings.ctrl_nav_text_sm')}}">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
