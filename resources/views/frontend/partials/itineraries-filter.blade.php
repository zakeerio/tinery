                                            ...
                                            @if (Auth::guard('user')->user())
                                                ...
                                                @if ($query->count() == 1)
                                                    <a href="javascript:void(0)" data-role="removetowishlist"
                                                        data-id="{{ $row->id }}"> <img
                                                            src="{{ asset('frontend/images/border-heart.svg') }}" alt=""
                                                            class="path-img"></a>
                                                @else
                                        ...
                                        @if ($offset > 0)
                                            <li class="page-item">
                                                <a class="page-link" href="javascript:void(0);" data-role="btnfilterpagination"
                                                    data-offset="{{ $offset - 1 }}" data-limit="{{ $limit }}"
                                        ...
                                        @for ($i = 0; $i < $totalPages; $i++)
                                            ...
                                            @else
                                                <li class="page-item"><a class="page-link" href="javascript:void(0);"
                                                        data-role="btnfilterpagination" data-offset="{{ $i }}"
                                                        data-limit="{{ $limit }}">{{ $i + 1 }}</a></li>
