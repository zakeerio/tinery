                                        ...
                                        <div id="collapseRelevantTags" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body p-1">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input type="hidden" name="id" value="{{ $user->id }}">
                                                    <div class="col-lg-12">
                                                        <small class="small-tiny-color ">Relevant tags will auto-populate
                                                            here based on the tags used in your itineraries.</small>
                            ...
                            <div class="row justify-content-center ">
                                <div class="col-lg-11">
                                    <div class=" d-flex justify-content-between align-items-center  my-lg-0 my-c ">
                                        @if (Auth::guard('user')->user())
                                            <ul class="nav nav-tabs profile-tabs d-flex gap-3 gap-lg-4 m-0 "
                                                ...
                                                <div class="row mb-3 itineraryItem">
                                                    <div class="d-flex gap-3 justify-content-between ">
                                                        <div class=" d-flex w-100   gap-3">
                                                            ...
                                                            @endif
                                                            <div class="w-100">
                                                                <h2 class="title title1 mb-0">{{ $itinerary->title }}
                                                                    &nbsp;</h2>
                                                                    ...
                                                                    <div class=" d-flex  gap-2 align-items-center ">
                                                                        @if ($usercheck)
                                                                            ...
                                                                            <a href="javascript:;"
                                                                                ...
                                                                                class="add-size-img align-items-center border d-flex justify-content-center rounded-pill text-decoration-none deleteItinerary"><i
                                                                                    class="fa fa-trash icons-color"></i></a>
                                                                        @endif
