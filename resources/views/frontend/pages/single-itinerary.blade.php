                            ...
                            <div class="d-flex justify-content-between  ">
                                ...
                                @if(Auth::guard('user')->user())
                                    @php
                                        ...
                                        @endphp
                                    @if($query->count() == 1)
                                    <a href="javascript:void(0)" data-role="removetowishlist" data-id="{{ $itinerary->id}}" data-source="single-itinerary"> <img src="{{ asset('frontend/images/heart-red.svg') }}" class="heart-size" alt=""></a>
                                    @else
                                    <a href="javascript:void(0)" data-role="addtowishlist" data-id="{{ $itinerary->id}}" data-source="single-itinerary"> <img src="{{ asset('frontend/images/border-heart.svg') }}" class="heart-size" alt=""></a>
                                    @endif
                                    @else
                                                                  ...
                                                                  {{-- <div class="d-flex justify-content-between"><div class=" d-flex align-items-center mb-2 mt-3 flex-wrap "><div class="fs-20-300 me-2">{{ $comment->user->name }} {{ $comment->user->last_name }}</div><div class="vr d-none d-sm-block "></div><div class="ms-2 time-left ">12 Hours Ago</div></div><div class=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                    ...
                                                                    <div class="comment-footer">
                                                                        <div class="row">
                                                                            ...
                                                                            @else
                                                                            <div class="col-1">
                                                                                <a href="javascript:;" onclick="return alert('Please Login your self before doing action')" class="btn btn-transparent"><img src="{{ asset('frontend/images/Like Animation.png') }}" alt=""></a>
                                                                            </div>
                                                                            <div class="col-1">
                                                                                <a href="javascript:;" onclick="return alert('Please Login your self before doing action')" class="btn btn-transparent"><img src="{{ asset('frontend/images/Dislike Animation.png') }}" alt=""></a>
                                                                            </div>
                                                                            @endif
